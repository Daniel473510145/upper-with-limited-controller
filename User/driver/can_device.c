...
void set_test_gimbal_current1(int16_t test_gimbal_current[])
{
  ...
  data[0] = test_gimbal_current[0] >> 8;
  data[1] = test_gimbal_current[0];
/* 
	data[2] = test_gimbal_current[1] >> 8;
  data[3] = test_gimbal_current[1];
  data[4] = test_gimbal_current[2] >> 8;
  data[5] = test_gimbal_current[2];
  data[6] = test_gimbal_current[3] >> 8;
  data[7] = test_gimbal_current[3]; */
  write_can(GIMBAL_CAN, CAN_GIMBAL_ID, data);
}
