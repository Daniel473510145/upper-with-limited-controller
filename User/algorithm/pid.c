...
/**
pid_t pid_test_moto_speed     = { 0 };
pid_t pid_test_moto_position  = { 0 };
pid_t pid_test_moto_speed_1     = { 0 };
pid_t pid_test_moto_position_1  = { 0 };
pid_t pid_test_moto_speed_move     = { 0 };
pid_t pid_test_moto_position_move  = { 0 };
pid_t pid_test_moto_speed_guardmove     = { 0 };
pid_t pid_test_moto_position_guardmove = { 0 }; */
